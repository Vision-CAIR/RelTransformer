...
if __name__ == '__main__':
    ...
    from core.test_engine_attention4_intentional_memory_only_key_memory_double_retrieval_balance_residual_redesign import run_inference
    ...
    if os.path.exists(det_file) & False:
