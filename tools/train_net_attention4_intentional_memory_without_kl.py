...
def main():
    ...
    from modeling.model_builder_attention4_intentional_memory_without_kl import Generalized_RCNN
    from core.test_engine_attention4_intentional_memory_without_kl import run_eval_inference, run_inference
    from core.test_engine_attention4_intentional_memory_without_kl import get_inference_dataset, get_roidb_and_dataset
