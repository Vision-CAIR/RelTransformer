...
def main():
    ...
    from modeling.model_builder_all_objects_meshed_memory_baseline import Generalized_RCNN
    from core.test_engine_all_objects_meshed_memory_baseline import run_eval_inference, run_inference
    from core.test_engine_all_objects_meshed_memory_baseline import get_inference_dataset, get_roidb_and_dataset
