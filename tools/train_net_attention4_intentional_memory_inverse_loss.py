...
def main():
    ...
    from modeling.model_builder_attention4_intentional_memory_inverse_loss import Generalized_RCNN
    from core.test_engine_attention4_intentional_memory_inverse_loss import run_eval_inference, run_inference
    from core.test_engine_attention4_intentional_memory_inverse_loss import get_inference_dataset, get_roidb_and_dataset
