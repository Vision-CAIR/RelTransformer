...
def main():
    ...
    from modeling.model_builder_fc_attention_wce3 import Generalized_RCNN
    from core.test_engine_fc_attention3 import run_eval_inference, run_inference
    from core.test_engine_fc_attention3 import get_inference_dataset, get_roidb_and_dataset
