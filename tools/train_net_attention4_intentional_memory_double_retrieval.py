...
def main():
    ...
    from modeling.model_builder_attention4_intentional_memory_only_key_memory_double_retrieval import Generalized_RCNN
    from core.test_engine_attention4_intentional_memory_only_key_memory_double_retrieval import run_eval_inference, run_inference
    from core.test_engine_attention4_intentional_memory_only_key_memory_double_retrieval import get_inference_dataset, get_roidb_and_dataset
