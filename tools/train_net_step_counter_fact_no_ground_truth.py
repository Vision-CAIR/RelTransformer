...
def main():
    ...
    from modeling.model_builder_counter_fact_no_ground_truth import Generalized_RCNN
    from core.test_engine_counter_fact_no_ground_truth import run_eval_inference, run_inference
    from core.test_engine_counter_fact_no_ground_truth import get_inference_dataset, get_roidb_and_dataset
