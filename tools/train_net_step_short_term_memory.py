...
def main():
    ...
    from modeling.model_builder_short_term_memory import Generalized_RCNN
    from core.test_engine_short_term_memory import run_eval_inference, run_inference
    from core.test_engine_short_term_memory import get_inference_dataset, get_roidb_and_dataset
