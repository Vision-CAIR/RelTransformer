...
import modeling.reldn_heads_all_objects_mem_both_double_retrieval_balance_redesign as reldn_heads
...
class Generalized_RCNN(nn.Module):
    ...
    def _forward(self, data, im_info, dataset_name=None, roidb=None, use_gt_labels=False, include_feat=False,  **rpn_kwargs):
        ...
        if self.training:
            ...
            prd_cls_scores, sbj_cls_scores, obj_cls_scores,att_all = \
