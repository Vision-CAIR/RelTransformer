...
import modeling.reldn_heads_attention4_intentional_memory_only_key_memory_double_retrieval_balance_residual_redesign as reldn_heads
...
class Generalized_RCNN(nn.Module):
    def __init__(self):
        ...
        self.kl_divergence_loss = nn.KLDivLoss(reduction="none")
        self._init_modules()
    ...
    def _forward(self, data, im_info, dataset_name=None, roidb=None, use_gt_labels=False, include_feat=False,  **rpn_kwargs):
        ...
        if cfg.MODEL.USE_SEM_CONCAT and concat_feat.shape[0] > gn_size:
            ...
            for i in range(group):
                ...
                prd_cls_scores_i, sbj_cls_scores_i, obj_cls_scores_i,w_all = \
        ...
        if self.training:
            ...
            #  maximize the entropy of memory attention
            # entropy_loss = []
            # for w in w_all:
            ...
            # return_dict["total_loss"] = return_dict["losses"]
