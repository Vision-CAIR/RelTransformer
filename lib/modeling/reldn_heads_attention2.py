...
class reldn_head(nn.Module):
    def __init__(self, dim_in, all_obj_vecs=None, all_prd_vecs=None):
        ...
        self.multi_head_attention = MultiHeadModel(2, 1024, 4, 1024)
    ...
    def forward(self, spo_feat, sbj_labels=None, obj_labels=None, sbj_feat=None, obj_feat=None):
        ...
        # calculate the multi modal attentions
        ...
        # print(prd_hidden.shape)
        '''
        the predicate visual features. [ sbj_visual_embedding, predicate visual, object_visual_embedding]
