...
class reldn_head(nn.Module):
    ...
    def forward(self, spo_feat, sbj_labels=None, obj_labels=None, sbj_feat=None, obj_feat=None):
        ...
        sbj_vis_embeddings_zombie,  obj_vis_embeddings_zombie, predicate_counterfact = self.multi_head_attention(None, None,
                                                                                        sbj_vis_embeddings, obj_vis_embeddings,
                                                                                        intervation_predicate)


        sbj_visual_counterfact, obj_vis_embeddings_zombie, predicate_zombie = self.multi_head_attention(None, None, intervation_sbj_vis, obj_vis_embeddings, prd_hidden)

        
        sbj_visual_zombie, obj_visual_counterfact, predicate_zombie = self.multi_head_attention(None, None, sbj_vis_embeddings, intervation_obj_vis, prd_hidden)
